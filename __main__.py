import asyncio
from harbor import ResourceBuilder, BuildContext
    ...
    for team in parsed_yaml.teams:
        for service in team.services:
            for environment in service.environments:
                ...
                # AzureNative
                context = BuildContext(team.name, service.name, environment.name, environment.location or {})
                builder = ResourceBuilder(context)
                await builder.build(environment.harbor)
